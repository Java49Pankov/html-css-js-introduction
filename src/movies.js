...
console.log(obj1 == obj2); //false , it`s various reference
console.log(JSON.stringify(obj1) == JSON.stringify(obj2)); //JSON - it`s string. JAVA SCRIPT OBJECT NOTATION
...
console.log(httpPrefix + moviesData.results[0].poster_path);
*/
