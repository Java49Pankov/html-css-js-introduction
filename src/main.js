...
import { EmployeeList } from "./ui/EmployeesList.js";
...
const listAllEmployees = new EmployeeList("employees-all");
const listEmployeesBySalary = new EmployeeList("employees-salary");
